...
public class BankCodeGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(System.getProperty("user.dir") + "/cx-edu-generator/src/main/java");
		gc.setAuthor("cx");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://localhost:3308/" + SERVICE_NAME
